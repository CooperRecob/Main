package edu.cs220.takeHomeLabs.lab2;
...
public class BarChart {
    ...
    public static void main(String[] args) {
        try {
            File file = new File("edu/cs220/takeHomeLabs/lab2/salesData.txt");
            ...
            input.close();
            FileWriter writer = new FileWriter("edu/cs220/takeHomeLabs/lab2/SalesBarChart.txt");
            for (int i = 0; i < data.length; i++) {
